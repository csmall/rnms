...
pollers = [
        ...
        ['output','SNMP Output Rate','snmp_counter','.1.3.6.1.2.1.2.2.1.16.<interfacenumber>'],
        ['outputerrors','SNMP Output Errors','snmp_counter','.1.3.6.1.2.1.2.2.1.20.<interfacenumber>'],
        ['inputerrors','SNMP Input Errors','snmp_counter','.1.3.6.1.2.1.2.2.1.14.<interfacenumber>'],
        ['interface_oper_status','SNMP Interface Operational Status','snmp_interface_status_all','8'],
        ['interface_admin_status','SNMP Interface Administrative Status','snmp_interface_status_all','7'],
        ['cpu','Cisco CPU Utilization','snmp_counter','.1.3.6.1.4.1.9.9.109.1.1.1.1.5.1'],
        ['inpackets','SNMP Input Packets','snmp_counter','.1.3.6.1.2.1.2.2.1.11.<interfacenumber>'],
        ['outpackets','SNMP Output Packets','snmp_counter','.1.3.6.1.2.1.2.2.1.17.<interfacenumber>'],
        ...
        ['drops','SNMP Drops','snmp_counter','.1.3.6.1.2.1.2.2.1.19.<interfacenumber>'],
        ...
        ['bandwidthin','Get Bandwidth IN from DB','db','bandwidthin,to_bytes'],
        ['bandwidthout','Get Bandwidth OUT from DB','db','bandwidthout,to_bytes'],
        ...
        ['input','SNMP Input Rate HC','snmp_counter','.1.3.6.1.2.1.31.1.1.1.6.<interfacenumber>'],
        ['output','SNMP Output Rate HC','snmp_counter','.1.3.6.1.2.1.31.1.1.1.10.<interfacenumber>'],
        ['inpackets','SNMP Input Packets HC','snmp_counter','.1.3.6.1.2.1.31.1.1.1.7.<interfacenumber>'],
        ['outpackets','SNMP Output Packets HC','snmp_counter','.1.3.6.1.2.1.31.1.1.1.11.<interfacenumber>'],
        ]
