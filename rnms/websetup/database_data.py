...
attribute_types = [
        ...
        ['Physical Interfaces',1,1,'snmp_interfaces','',2,'AVERAGE','103680',300,3,1,'none',0,1,1,'.',[
            ...
            [u'Input Bytes', 'input', 2,0,0,'speed'],
            [u'Output Bytes', 'output', 2,0,0,'speed'],
            [u'Input Packets', 'inpackets', 2,0,0,'speed'],
            [u'Output Packets', 'outpackets', 2,0,0,'speed'],
            [u'Input Errors', 'inputerrors', 2,0,0,'speed'],
            [u'Output Errors', 'outputerrors', 2,0,0,'speed'],
            [u'Round Trip Time', 'rtt', 1,0,10000,''],
            [u'Packet Loss', 'packetloss', 1,0,1000,''],
            [u'Drops', 'drops', 2,0,0,'speed'],
                ] ],
...
pollers = [
        ...
        ['app_status,current_instances','Host MIB Process Verifier','hostmib_apps','<interface>'],
        ...
        ['forward_jitter','SA Agent Forward Jitter','cisco_saagent_forwardjitter',''],
        ['backward_jitter','SA Agent Backward Jitter','cisco_saagent_backwardjitter',''],
        ['rt_latency','SA Agent Round-Trip Latency','cisco_saagent_rtl',''],
        ['forward_packetloss','SA Agent fw % PacketLoss','cisco_saagent_fwpacketloss',''],
        ['backward_packetloss','SA Agent bw % PacketLoss','cisco_saagent_bwpacketloss',''],
        ...
        ['ping','Reachability Start FPING','reachability_start',''],
        ['wait','Reachability Wait until finished','reachability_wait',''],
        ['rtt','Reachability RTT','reachability_values','rtt'],
        ['packetloss','Reachability PL','reachability_values','pl'],
        ['ping_cleanup','Reachability End','reachability_end',''],
        ['status','Reachability Status','reachability_status',''],
