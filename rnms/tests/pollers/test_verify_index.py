...
from rnms.lib.pollers.verify_index import filter_storage_name, poll_verify_storage_index, cb_storage_index, cb_verify_storage_index
...
class TestVerifyIndexPoller(PollerTest):
    def test_poll_storage_ok(self):
        ...
        eq_(poll_verify_storage_index(self.poller_buffer, **self.test_kwargs), True)
        self.assert_get_str_called((1,3,6,1,2,1,25,2,3,1,3,1),cb_storage_index)
    ...
    def test_poll_storage_noindex(self):
        ...
        eq_(poll_verify_storage_index(self.poller_buffer, **self.test_kwargs), False)
