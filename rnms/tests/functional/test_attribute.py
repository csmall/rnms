...
class TestAttributeController(TestController):
    ...
    def test_map_hostid_notnum(self):
        ...
        self.check_response_as_admin('/attributes/map?h=abc',
            ( 'Please enter an integer value for Host ID',))
